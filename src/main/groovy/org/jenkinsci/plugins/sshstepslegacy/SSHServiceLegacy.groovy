package org.jenkinsci.plugins.sshstepslegacy
...
import org.jenkinsci.plugins.sshstepslegacy.util.Common
import org.jenkinsci.plugins.sshstepslegacy.util.CustomLogHandler
...
@Slf4j
@SuppressFBWarnings
class SSHServiceLegacy implements Serializable {
     ...
     * @param logger
     */
    private SSHServiceLegacy(Map remote, boolean failOnError, boolean dryRun, PrintStream logger) {
        this.remote = remote
        this.logger = logger
    ...
    static SSHServiceLegacy create(Map remote, boolean failOnError, boolean dryRun, PrintStream logger) {
        new SSHServiceLegacy(remote, failOnError, dryRun, logger)
    }
