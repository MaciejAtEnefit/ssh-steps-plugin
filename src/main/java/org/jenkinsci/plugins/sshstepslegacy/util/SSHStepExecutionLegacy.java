 ...
 * @see StepExecution
 */
public abstract class SSHStepExecutionLegacy<T> extends StepExecution {
  ...
  protected SSHStepExecutionLegacy(BasicSSHStepLegacy step, @Nonnull StepContext context)
    ...
    if (executorService == null) {
      executorService = Executors.newCachedThreadPool(
          new NamingThreadFactory(new ClassLoaderSanityThreadFactory(new DaemonThreadFactory()),
              "org.jenkinsci.plugins.ssh.util.SSHStepExecutionLegacy"));
    }
